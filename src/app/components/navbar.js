...
function Navbar() {
    return (
        <nav className="flex justify-between items-center py-4 px-8 bg-gray-100 border-b text-black border-gray-300">
            ...
            <div className="flex gap-4">
                <Link href="/profile" className ="group relative"> 
                    <PersonStanding size={24} className="cursor-pointer"/>
                    <span className="absolute left-0 -bottom-1 w-full h-0.5 bg-blue-500 scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left rounded-full pointer-events-none"/>
                </Link>
            </div>
        </nav>
